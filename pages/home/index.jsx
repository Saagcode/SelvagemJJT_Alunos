...
function Home() {
  ...
  useEffect(() => {
    ...
    const storedSelectedTime = localStorage.getItem("storageSelectedTime");
    if (storedSelectedTime) {
      setSelectedTime(storedSelectedTime);
    }
    const newDataClass = localStorage.getItem("newDataClasses");
    if (newDataClass) {
  ...
  let tomorrowDay = parseInt(day, 10) + 1;
  ...
  function handleTomorrowRadioChange() {
    day = "0" + day;
    if (day < 10) {
      setStorageSelectedDate(`${parseInt(day, 10) + 1}/${month}/${year}`);
    }
    setTodayRadio(false);
    ...
    if (
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          localStorage.setItem("storageSelectedDate", storageSelectedDate);
          localStorage.setItem("storageSelectedTime", storageSelectedTime);
          const newDataClasses = [
            ...dataClasses,
            { date: storageSelectedDate, time: storageSelectedTime },
          ];
          localStorage.setItem(
            "newDataClasses",
            JSON.stringify(newDataClasses)
          );
  ...
  //         } else {
  //           throw new Error("Falha ao buscar detalhes do usuario");
  //         }
  //       } catch (error) {
  //         console.error("Erro ao buscar Usuario na requisicao:", error);
  //         Swal.fire({
    ...
    <>
      <section className="section-menu_container">
        <div className="grid-menu_content">
          <div
            className={showMenu ? "elipsis-menu" : "elipsis-menu_2"}
            onClick={show}
          >
            <span className="ball" />
            <span className="ball" />
          ...
          <div className="container-logout">
            ...
            <button className="btn_exit" onClick={handleLogout}>
              <span
                className={
                  door ? "fa-solid fa-door-open" : "fa-solid fa-door-closed"
                }
                onMouseEnter={doorOpen}
          ...
          <div className="class-history">
            ...
            <div className="scroll-classes">
              ...
              {dataClasses.map((classData, index) => (
                <h1 key={index} className="history-schedules">
                  {" "}
                  <br />
            ...
            <dialog className="modal-dialog" open>
              ...
              <section className="section-schedule_class">
                <div className="container-kimono-profile">
                  ...
                  color5 ? (
                    <img
                      src={kimono_profile_2}
                      alt="kimono"
                      className="kimono-profile_2"
                    />
                  ) : (
                    <img
                      src={kimono_profile}
                      alt="kimono"
                      className="kimono-profile"
                      data-aos="zoom-in"
                ...
                <div>
                  <h1 className="title-date">Data de agendamento:</h1>
                  <div className="radio-input">
                    <label htmlFor="today">
                      <input
                        ...
                        id="today"
                        checked={todayRadio}
                        onChange={handleTodayRadioChange}
                      />
                      Hoje ({day}/{month}/{year})
                    </label>
                    <label htmlFor="tomorrow">
                      <input
                        ...
                        className="tomorrow"
                        id="tomorrow"
                        checked={tomorrowRadio}
                        onChange={handleTomorrowRadioChange}
                      />
                      Amanhã ({tomorrowDay}/{month}/{year})
                    </label>
                  </div>
                </div>
                <div>
                  <h1 className="title-schedule">Qual o melhor horário?</h1>
                  <div className="schedules">
                    <hgroup>
                      <h1
                        className={
                          color1 ? "schedules-change" : "schedules-default"
                        }
                      ...
                      <h1
                        className={
                          color2 ? "schedules-change" : "schedules-default"
                        }
                      ...
                      <h1
                        className={
                          color3 ? "schedules-change" : "schedules-default"
                        }
                      ...
                      <h1
                        className={
                          color4 ? "schedules-change" : "schedules-default"
                        }
                      ...
                      <h1
                        className={
                          color5 ? "schedules-change" : "schedules-default"
                        }
              ...
              <button
                className="container-confirm-btn"
